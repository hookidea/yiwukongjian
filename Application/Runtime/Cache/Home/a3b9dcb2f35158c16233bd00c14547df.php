     ...
     <div class="container">
        <div class="suibian">
          <ul class="middle_nav">
            ...
            <li class="personalhover"><a href="/Lost/getUserList">招领管理</a></li>
                ...
                <div class="xs_beg">
                  <div class="commodity_beg">
                    ...
                    <div class="text_details_beg">
                      ...
                      <?php if ($lostList[$y]['is_full'] == 0) { ?>
                          <div class="fin_btn beg_btn" onclick="javascript:full(<?php echo $curr; ?>, 'lost');">
                              确定完成
                          </div>
                      <?php } else { ?>
                      ...
                      <a href="/Lost/edit/lost_id/<?php echo $curr; ?>">
...
<div class="mt20">
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Lost/getUserList?wap=1" target="_blank">手机版</a>
