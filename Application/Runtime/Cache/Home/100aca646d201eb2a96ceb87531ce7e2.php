                ...
                <div class="consignee-scrollbar" style="position: absolute; left: 0px; top: 0px; overflow: hidden; height: 840px; width: 100%;">
                  <div class="ui-scrollbar-main">
                    ...
                    <!--  -->
                      ...
                      <?php if(is_array($addressList)): foreach($addressList as $key=>$address): if(($key) == "0"): if(($address["is_default"]) == "1"): ?><input type="hidden" name="address_name" value="<?php if(($address["is_default"]) == "1"): echo ($address["address_name"]); endif; ?>">
                          ...
                          <li selected="selected" id="consignee_index_137842514" style="display: list-item;" class="ui-switchable-panel ui-switchable-panel-selected">
                            ...
                            <div class="addr-detail" title="<?php echo ($address["address_location"]); ?>">
                               ...
                               <?php if(($address["is_default"]) == "1"): ?><span class="addr-default">默认</span><?php endif; ?>
                            </div>
                            <div class="op-btns">
                              <span></span>
          ...
          <div id="shipAndSkuInfo">
              <div id="payShipAndSkuInfo">
                ...
                <div class="step-tit">
                  <h3>订单清单</h3>
                  <div class="extra-r">
                    <a href="#none" id="price-desc" class="price-desc" title="因可能存在系统缓存、页面更新导致价格变动异常等不确定性情况出现，商品售价以本结算页商品价格为准；如有疑问，请您立即联系销售商咨询。">
                      <i></i>&nbsp;注意
                    </a>
                          <a clstag="pageclick|keycount|trade_201602181|15" class="return-edit ftx-05" id="cartRetureUrl" href="/Cart/showCart">返回购物车</a>
                      </div>
                </div>
                ...
                <div id="skuPayAndShipment-cont" class="step-cont">
                  <div id="shopping-lists" class="shopping-lists">
                    ...
                    <?php if(is_array($groupList)): foreach($groupList as $key=>$group): ?><!-- Ò»¸öµê¼ÒµÄ¿ªÊ¼ -->
                      <div class="shopping-list ABTest">

                      <?php if(is_array($group)): foreach($group as $key=>$good): ?><!-- Òþ²Ø±íµ¥ -->
                        <input type="hidden" name="good_id[]" value="<?php echo ($good["good_id"]); ?>">
                        <input type="hidden" name="num[]" value="<?php echo ($good["num"]); ?>">

                        <!-- Ò»¸öÉÌÆ·½áÊø -->
                        <div class="goods-list">
                          <div class="goods-tit">
                            <h4 id="0" class="vendor_name_h">商家：<?php echo ($good["user_name"]); ?></h4>
                          </div>
                          ...
                          <div class="goods-items">
                            <div goods-id="1039799" class="goods-item goods-item-extra">
                              ...
                              <div class="p-img">
                                <a href="/<?php echo ($good["good_id"]); ?>.html" target="_blank"><img alt="" src="<?php echo ($good["thumb_img"]); ?>"></a>
                              </div>
                              <div class="goods-msg">
                                <div class="goods-msg-gel">
                                  <div class="p-name">
                                       <a target="_blank" href="/<?php echo ($good["good_id"]); ?>.html">
                                         <?php echo ($good["good_name"]); ?>
                                       </a>
                                  </div>
                                    <div class="p-price">
                                        <strong class="jd-price">￥<?php if(($good["is_promote"]) == "1"): echo ($good["promote_price"]); else: echo ($good["shop_price"]); endif; ?></strong>
                                        <span class="p-num">x<?php echo ($good["num"]); ?></span>
                                        <span skuid="1039799" class="p-state" id="pre-state"><?php if(($good["good_number"]) > "0"): ?>有货<?php else: ?>无货<?php endif; ?></span>
                                    </div>
                                </div>
                              </div>
                              <div class="clr"></div>
    ...
    <div class="order-summary">
      <div class="statistic fr">
        <div class="list">
            ...
            <em v="104.9" id="warePriceId" class="price-order">￥<?php echo ($shop_price_total); ?></em>
        </div>
        <div class="list">
            <span>优惠/促销：</span>
            <em v="0" id="cachBackId" class="price-order"> -￥<?php echo ($sheng); ?></em>
        </div>
      </div>
      <div class="clr"></div>
    </div>
    ...
    <div class="trade-foot">
      <div class="trade-foot-detail-com">
        <div class="fc-price-info">
          ...
          <span id="sumPayPriceId" class="price-num">￥<?php echo ($total); ?></span>
        </div>
      ...
      <div class="group" id="checkout-floatbar">
        <div class="ui-ceilinglamp checkout-buttons">
          ...
          <div class="sticky-wrap">
            <div class="inner">
              <button onclick="return submitOrder();" class="checkout-submit">
                提交订单
                <b></b>
              </button>
            </div>
...
function submitOrder () {
    ...
    // if (confirm('提交之后将不能够取消订单，确定提交该订单？')) {

      $.post('/Order/create', $('#order-form').serialize(), function (msg) {
        backAppend(msg);
      });
      // return false;
    // }
  ...
  $(this).find('.op-btns').css('visibility', 'hidden');
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Order/accounts?wap=1" target="_blank">手机版</a>
