     ...
     <div class="container">
        <div class="suibian">
          <ul class="middle_nav">
            ...
            <li class="personalhover"><a href="/Beg/getUserList/user_id/<?php echo ($_GET['user_id']); ?>">TA的求购</a></li>
                              ...
                              <?php } else { ?>
                                <p class="user_comment_beg">
                                  ...
                                  <a href="/User/showUser/user_id/<?php echo $vo[$z]['raply_id']; ?>">
                                   <span uid="<?php echo $vo[$z]['raply_id']; ?>"><?php echo $vo[$z]['raply_name']; ?></span>
                                  </a>
                                </p>
                               <?php } ?>
...
<div class="mt20">
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Beg/getUserList/user_id/2?wap=1" target="_blank">手机版</a>
