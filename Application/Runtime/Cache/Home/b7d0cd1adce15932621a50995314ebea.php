						...
						<div>
							<div class="contacts_beg">
								<a href="/User/showUser/user_id/<?php echo $lostList[$y]['user_id']; ?>">
									...
									<a title="联系他/她" href="#none" class="btn-im btn-im-jd tel_me_show beg-tel" onclick="addLetter(<?php echo $lostList[$y]['user_id']; ?>, '<?php echo $lostList[$y]['user_name']; ?>', <?php echo ((isset($_SESSION['shop']['user']) && ($_SESSION['shop']['user'] !== ""))?($_SESSION['shop']['user']):-1); ?>);"></a>
							</div>
...
<?php else: ?>
	<?php if(empty($_GET['keyword'])): ?><p class="info-p">抱歉，暂无招领信息，正在返回上一页...</p>
		<?php else: ?>
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Lost/getList?wap=1" target="_blank">手机版</a>
