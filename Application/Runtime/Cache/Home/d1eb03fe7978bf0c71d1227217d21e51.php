...
<div id="body-wrap">
 ...
 <link rel="stylesheet" type="text/css" href="/Public/Home/Css/showMessage.css?v=2.1">
<div class="container">
	<div class="suibian">
		<ul class="middle_nav">
								...
								<div class="mg-noticelist" style="position: absolute; left: 0px; top: 0px; overflow: hidden;">
									<div class="ui-scrollbar-main">
										<ul>
	    									...
	    									<li onclick="queryByType(4)" class="mg-types <?php if(($_GET['type']) == "4"): ?>mg-types-cur<?php endif; ?>">
								        		<span class="mg-timg actimg">
	    										<s id="unsubscribe_icon_1" class="hide"></s>
	    								        </span>
	    						        		<div class="mg-tcont">
						...
						<div class="ui-scrollbar-wrap" style="position: relative; height: 675px; z-index: 0;">
							<div class="ui-scrollbar-main" style="margin-top:10px">
								...
								<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>
										...
										<div class="mg-box">
											<div class="mg-title">
	    										<h4 style="float: left"><?php echo ($vo["title"]); ?></h4>
											</div>
											<div class="mg-content clearfix">
												<div>
													<?php echo ($vo["content"]); ?>
												</div>
										    	<a target="_blank" onclick="" href="<?php echo ($vo["url"]); ?>" class="mg-details">
										    		链接&nbsp;&gt;&nbsp;
										    	</a>
										    </div>
										</div>
...
<div class="mt20">
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Message/showMessage?wap=1" target="_blank">手机版</a>
