     ...
     <div class="container">
        ...
        <div class="suibian">
          <ul class="middle_nav">
            ...
            <li class="personalhover"><a href="/Good/getUserList">商品管理</a></li>
       ...
       <div class="qq">
         <div class="sc">
          ...
          <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="enshr_each">
                 <img src="<?php echo ($vo["thumb_img"]); ?>" alt="">
                 ...
                 <div class="enshr_state">
                    <?php if(($vo["is_check"]) == "0"): ?><span class="onsaling">审核已通过</span>
                      <?php else: ?>
                      <span class="onsaling">审核未通过</span><?php endif; ?>
                    <?php if(($vo["is_on_sale"]) == "0"): ?><span class="onsaling">下架中</span>
                      <?php else: ?>
                    ...
                    <a href="javascript: onSale(<?php echo ($vo["good_id"]); ?>, <?php echo ($vo["is_on_sale"]); ?>);">
                      <?php if(($vo["is_on_sale"]) == "0"): ?><span class="good_btn on_sale_btn">上架</span>
                        <?php else: ?>
                          <span class="good_btn on_sale_btn">下架</span><?php endif; ?>
                    </a>
                    <!-- <span class="good_btn">编辑</span> -->
...
<div class="mt20">
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Good/getUserList?wap=1" target="_blank">手机版</a>
