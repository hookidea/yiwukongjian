...
<div id="body-wrap">
 ...
 <div class="wrap_beg">
		<div class="buying_area_beg">
			<img src="/Public/Home/Img/want-title.png" alt="" />
			<form method="get" action="/Beg/getList">
				<a href="/Beg/issue"><input type="button" value="我要发布" class="beg_issue"></a>
	            <input type="submit" name="" value="搜索" class="beg_sub">
				<input type="text" name="keyword" class="beg_text" value="<?php echo ($_GET['keyword']); ?>">
			</form>
		</div>
		<div class="xian_beg">
		</div>
						...
						<div>
							<div class="contacts_beg">
								<a href="/User/showUser/user_id/<?php echo $begList[$y]['user_id']; ?>">
									...
									<a title="联系他/她" href="#none" class="btn-im btn-im-jd tel_me_show beg-tel" onclick="addLetter(<?php echo $begList[$y]['user_id']; ?>, '<?php echo $begList[$y]['user_name']; ?>', <?php echo ((isset($_SESSION['shop']['user']) && ($_SESSION['shop']['user'] !== ""))?($_SESSION['shop']['user']):-1); ?>);"></a>
							</div>
...
<?php else: ?>
	<?php if(empty($_GET['keyword'])): ?><p class="info-p">抱歉，暂无求购信息，正在返回上一页...</p>
		<?php else: ?>
    ...
    <div class="footer">
        <div class="links">
            ...
            <a href="/Beg/getList?wap=1" target="_blank">手机版</a>
