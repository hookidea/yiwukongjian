...
class EmailController extends Controller
{
    public function test ()
    {
        ...
        $mail->setServer('smtp.sina.com', 'parstore@sina.com', 'slgmdddsl', 465, true);
        $mail->setFrom('parstore@sina.com');
        $mail->setReceiver('hookidea@qq.com');

        $mail->setMail('你现在在哪里》？》', '你现在在哪里》？》');
