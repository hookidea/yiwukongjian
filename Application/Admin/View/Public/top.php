...
<body>
  <div id="header-div">
    ...
    <div id="logo-div" style="bgcolor:#000000;">
      <!-- <img src="/Public/Admin/Img/ecshop_logo.gif" alt="" /> -->
    </div>
    ...
    <div id="submenu-div">
      <ul>
        <li>
          <?php session_start(); ?>
          <a href="/User/showUser/user_id/<?php echo $_SESSION['shop']['user']['user_id']; ?>" target="_blank">
          <?php echo $_SESSION['shop']['user']['user_name']; ?>
          (<?php echo $_SESSION['shop']['user']['role_name']; ?>)
          </a>
        </li>
        <li>
          <a href="/Index/index" target="_blank">查看网站首页</a>
        </li>
      </ul>
      <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
        <a href="javascript: top.frames['main-frame'].location.reload();" target="main-frame" class="fix-submenu">刷新</a>
        <a href="javascript: top.frames['main-frame'].history.go(-1);" target="main-frame" class="fix-submenu">返回</a>
        <!-- <a href="#" target="main-frame" class="fix-submenu">清除缓存</a> -->
        <a href="/User/logout" target="_top" class="fix-submenu">退出</a>
      </div>
      <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;">
        <img src="/Public/Admin/Img/top_loader.gif" width="16" height="16" alt="正在处理您的请求..." style="vertical-align: middle" />
        正在处理您的请求...
      </div>
    </div>
  ...
  <!-- <div id="menu-div">
    <ul>
      ...
      <li>
        <a href="#" target="main-frame">起始页</a>
      </li>
      <li>
        <a href="#" target="main-frame">设置导航栏</a>
      </li>
      <li>
        <a href="goodslist.php" target="main-frame">商品列表</a>
      </li>
      <li>
        <a href="#" target="main-frame">订单列表</a>
      </li>

      <li>
        <a href="#" target="main-frame">用户评论</a>
      </li>
      <li>
        <a href="#" target="main-frame">会员列表</a>
      </li>
      <li>
        <a href="#" target="main-frame">商店设置</a>
      </li>
