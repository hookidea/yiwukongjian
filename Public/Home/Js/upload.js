...
* @Last Modified time: 2016-05-19 23:02:43
*/
    ...
    reader.onload = function(e){
        $.post("/Good/uploadImg", { img: e.target.result}, function(msg){
            ...
            if (msg.status == 1) {
                ...
                if (len < 5) {
                    $('.photo-area').prepend('<div class="photo" id="image'+curr+'"><span class="close" onclick="closeDiv(this)"></span><div><img width="140" height="140" src="' + e.target.result + '" alt="" class="image" url=""></div><div class="processbar hide" id="o_1afm0hqb853l6g21fjs3mt1au9" style="width: 100%;"></div><div class="full-div"></div><div class="full-div"></div></div>');
